##### Videos:
    ...
    3. [2016 Short-Read Sequencing Analysis Workshop](https://bficores.colorado.edu/biofrontiers-core-facility-workshops/workshops-in-the-series/short-read-2016-course-materials)

##### Lectures:
    1. [DTU Denmark Courses](http://www.cbs.dtu.dk/courses/27626/programme.php)
    2. [Bioinformatics Using Python](https://github.com/Pfern/BPBR16-Bioinformatics-using-Python-for-Biomedical-Researchers)
    3. [Up-to-date RNA-Seq Analysis Training/Courses/Papers](https://www.biostars.org/p/174376/)
    4. [Data Management in Bioinformatics](https://en.wikibooks.org/wiki/Data_Management_in_Bioinformatics)
    5. [A study of migrating biological data from RDBMS to NoSQL](https://etd.ohiolink.edu/!etd.send_file?accession=ysu1442486094&disposition=inline)
